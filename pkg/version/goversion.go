...
// Info provides the goVersion info.
type Info struct {
...
// Option can be used to customize the goVersion after it is gathered from the
// environment.
...
// String returns the string representation of the goVersion info
...
// JSONString returns the JSON representation of the goVersion info
